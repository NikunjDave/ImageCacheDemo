...
public class ImageCache {
    ...
    public void initDiskCache() {
        Log.e("**","init disk cache "+Thread.currentThread().getName());
        // Set up disk cache
            ...
            if (mDiskLruCache == null || mDiskLruCache.isClosed()) {
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            Log.e("**","init disk cache 2 "+Thread.currentThread().getName());
    ...
    public static class ImageCacheParams {
         ...
         * {@link ImageCache#getInstance(androidx.fragment.app.FragmentManager, ImageCacheParams)} or
         * {@link ImageWorker#addImageCache(androidx.fragment.app.FragmentManager, ImageCacheParams)}.
